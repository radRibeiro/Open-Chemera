...
//function isInnerPointM(C:TCoord; fPoints:TCoords; fRads:TFloats):Boolean;cdecl;
...
//function isInnerPointM(C:TCoord; fPoints:TCoords; fRads:TFloats):Boolean;cdecl;external;
