__kernel void marrow_kernel(global float* out_arrayfloat0, global float* matrixfloat1, global float* batchfloat2, const unsigned long size0, const unsigned long size1, const unsigned long size2) {
// currentDim:  2
// currentDim:  1
...
out_arrayfloat0[index012] = local0 * local0;
}
